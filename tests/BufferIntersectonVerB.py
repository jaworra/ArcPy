...
out_feature_class = "Contour_70dBA_LEFT"
xy_tolerance = ""
...
#Set local variables
OutFileDir = "G:\Geospatial\GIS\JohnW\QRN\CaseStudy1\QLD_Development_Code_Noise_Contours\JW_Workings\Buffer_TTSF_RHT.shp"
DistField = "D70dbV"
SideType = "FULL"
EndType = "ROUND"
DisType = "NONE"
...
#Dissolve
arcpy.Dissolve_management('Buffer_TTSF_RHT', 'Buffer_TTSF_RHT',"", "", "", "")    

#Clip Buffer @ 150m
#Create polygon to clip
arcpy.Buffer_analysis('templine' , 'ClipBuffer' ,'150 meter', "RIGHT", "ROUND", "NONE",) 

#Set local variables
in_features = "Buffer_TTSF_RHT"
clip_features = "ClipBuffer"
out_feature_class = "Contour_70dB_RIGHT"
xy_tolerance = ""
...
#Merge and Disolve
arcpy.Merge_management(["Contour_70dBA_LEFT", "Contour_70dB_RIGHT"], "Contour_70dBA")
arcpy.Dissolve_management("Contour_70dBA", "Contour_70dBA","", "", "", "")    
##-------------------------------------------------------------------------------------------
#Cosmetic
