...
def CalcGeometryFunction(InputFeatClass, OuputFeatClass):
    ...
    for FP in AttributeAssign: #range(0,len(AttributeAssign)):
        point2.X = FP[1]
        point2.Y = FP[2]
    ...
    gp.SpatialJoin("splitline","AssignRow", OuputFeatClass, "#", "#","#","INTERSECT")
...
RailDataset = #"SEQ"#"StateWide_MetrageRoads_MGA56"
