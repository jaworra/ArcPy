...
for lyr in arcpy.mapping.ListTableViews(mxd):
    ...
    lyr = "Seg_events"
    SaveLoc = "G:/Geospatial/GIS/JohnW/QRN/CaseStudy1/QLD_Development_Code_Noise_Contours/JW_Workings/20130305/"
    ...
    print "A"
    arcpy.CopyFeatures_management(ProjectedFeat,SaveLoc+tbl+"_SegmentedLine.shp") # ERROR DOEST NOT REWRITE??
    print "B"
    ...
    SoundCat3 = "80dbV"
    SoundCat4 = "85dbV"
    ClipLimit = "250mV" #Either 150mV or 250mV
    ...
    ##-------------------------------------------------------------------------------------------
    #Copy and Append 
    arcpy.CopyFeatures_management("Contour_70dbV",SaveLoc+tbl+"_Contour_MergeResult.shp")
