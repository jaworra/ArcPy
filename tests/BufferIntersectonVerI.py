...
for lyr in arcpy.mapping.ListTableViews(mxd):
    ...
    lyr = "Seg_events"
    SaveLoc = "G:/Geospatial/GIS/JohnW/QRN/CaseStudy1/QLD_Development_Code_Noise_Contours/JW_Workings/20130307/Deliverables/"
    ...
    arcpy.MakeFeatureLayer_management(tbl+"_Contour_MergeResult", tbl+"lyrContour")
